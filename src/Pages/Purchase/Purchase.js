            ...
            <div class="hero min-h-screen bg-base-100">
                <div class="hero-content text-left flex-col lg:flex-row bg-indigo-200">
                    ...
                    <div>
                        ...
                        <input type="number" name="quantity" placeholder='Type quantity' readOnly value={orderQuantity} className='input input-bordered' />
                        ...
                        <MinusIcon
                            ...
                            <p class="py-1">Price: {product.price} </p><br />
                            ...
                            <input  class="btn btn-primary uppercase text-white font-bold bg-gradient-to-br from-primary to-secondary text-white" type="submit" value=" Order " />
                        </form>
