...
const ReviewAdd = () => {
    ...
    return (
        <section className='flex justify-center mt-12'>
            <div>
                <h2 className='text-2xl text-center text-accent'>Please Review Us</h2>
                <form onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <input className='uppercase text-white font-bold bg-gradient-to-br from-primary to-secondary w-full max-w-xs' type="submit" value="Add" />
                </form>
            </div>
        </section>
    )
