    ...
    return (
        <div style={{
            ...
            <div class="hero-content flex-col lg:flex-row-reverse ">
                ...
                <img src={about} class=" rounded-lg" alt='' />
                <div>
                    <h1 class="text-5xl "><span className='text-primary'>About</span><span className='text-secondary'> Auto Mart</span></h1>
                    <p class="py-6">Auto Mart an ISO-00000000 certified company is a leading manufacturer in the auto spare parts industry delivering you best in class aftermarket parts. We cater to the exacting requirements of the automotive industry with high-quality parts for trucks, tractors, cars and trailers to name a few.
